      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text.rich(TextSpan(
              text: "Bem-vindo, ", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 26),
              children: [
                TextSpan(
                text: "Alucard", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white),
                )
              ]
            )
            ),
