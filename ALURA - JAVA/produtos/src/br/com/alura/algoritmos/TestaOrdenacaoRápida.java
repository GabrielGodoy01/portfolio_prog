...
public class TestaOrdenacaoRápida {
    public static void main(String[] args) {
        ...
        double buscar = number.nextDouble();

        ordena(notas, 0, notas.length);
        int encontrei = busca(notas, 0, notas.length, buscar);
        if(encontrei == -1){
            System.out.println("\nNão existe o valor digitado!");
        }else{
            System.out.println("\nEncontrei a nota na posição: " + encontrei+"\n");
        }
